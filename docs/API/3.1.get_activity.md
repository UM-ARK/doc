...
| club_name | get a club info by club name    | http://XXX.XXX/api/get_activity/club/?s=電腦學會         |
| club_num  | get a club info by club_num     | http://XXX.XXX/api/get_activity/club_num/?club_num=1 |
