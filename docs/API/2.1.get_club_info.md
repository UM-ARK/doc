...
| club_num   | get a club info by club number |http://XXX.XXX/get_club_info/club_num/?club_num=1|
...
|---------|--------|----|----------|-------|
|club_num |yes     |int |to query info for the specified club_num|http://XXX.XXX/get_club_info/club_num/?club_num=1|
